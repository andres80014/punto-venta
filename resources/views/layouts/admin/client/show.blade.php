    ...
    <div class="content-wrapper">
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Panel administrador</a></li> <li class="breadcrumb-item"><a href="{{route('products.index')}}">Productos</a></li>
                                ...
                                <div class="profile-feed">
                                    <div class="d-flex align-items-start profile-feed-item">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <hr>
                                            <strong><i class="fas fa-address-card mr-1"></i> Categoria</strong>
                                            <p class="text-muted">
